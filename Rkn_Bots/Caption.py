...
async def start_cmd(bot, message):
    ...
    await message.reply_photo(photo=Rkn_Bots.RKN_PIC,
        ...
        reply_markup=types.InlineKeyboardMarkup([[
            ...
            types.InlineKeyboardButton('DEVLOPER', url='https://renishrplay.github.io/RENISH')
            ],[
            types.InlineKeyboardButton('🔥 Source Code 🔥', url='https://renishrplay.github.io/RENISH')
    ]]))
